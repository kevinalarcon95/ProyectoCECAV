<!-- modal delete user -->
<div class="modal fade" id="exampleModal{{$objInscripcionI->id}}"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        
            <?php $num = App\Http\Controllers\EstudianteOfertaController::existeInscripcionPreicfes($objInscripcionI->id) ?>
            ...
            <div class="modal-footer" style="border: none;">
                ...
                @if ($num != 0)
                <form action="{{url('/eliminarInscripcionPreicfes')}}/{{$objInscripcionI->id}}" method="POST">
                    @csrf
                    {{method_field('DELETE')}}
