...
<div class="container w-75  mt-5">
    <div class="row">
        ...
        <div class="col-6 text-white bg" style="justify-content: center !important;align-items: center; display: flex; flex-wrap: wrap; background-color: #04153B;">
            <div class="row mt-5">
                <img src="{{ asset('img/logo.png') }}" alt="logoUnicauca" width="180" height="180" style="margin-top: -11%;">
            </div>
            <div class="row text-center mx-5">
                <h4 class="fw-bold ">CECAV</h4>
                <p class="">CENTRO DE EDUCACIÓN <br> CONTINUA, ABIERTA Y VIRTUAL</p>
            </div>
        </div>
    </div>
</div>
...
<style>
    .bg {
        background: #04153B;
        background: linear-gradient(70deg, #291331, #04153B);;
    }
</style>
<!-- 
<div class="container">
