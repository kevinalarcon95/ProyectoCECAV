        ...
        <form action="{{route('/admin/createOferta')}}" method="POST">
            ...
            <div class="row m-3 pt-3">
                <div class="col">
                    ...
                    <div class="mb-3">
                        ...
                        $date = date('Y-m-d');
                        ?>
                        <input type="date" class="form-control" name="" id="exampleInputEmail1" style="background-color: #ececec;">
                    </div>
                    <div class="mb-3">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="formFile" style="background-color: #ececec;">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="descripcionOferta" class="form-control" id="exampleInputPassword1" placeholder="Valor de inversión" style="background-color: #ececec;"></textarea>
                    </div>
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col" style="text-align: right;">
                    <button type="button" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                            <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                        </svg> Cancelar</button>
                    <button type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-down-left" viewBox="0 0 16 16">
