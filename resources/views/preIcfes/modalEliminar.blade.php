<!-- modal delete user -->
<div class="modal fade" id="modalEliminar{{$varPreicfes->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <?php $num = App\Http\Controllers\PreicfesController::existeInscritos($varPreicfes->id) ?>
            ...
            <div class="modal-footer" style="border: none;">
                ...
                @if ($num == 0)
                <form action="{{url('/admin/deletePreicfes/'.$varPreicfes->id)}}" method="post">
                    @csrf
                    {{method_field('DELETE')}}
